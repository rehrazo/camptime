...
CREATE TABLE categories (
    ...
    home_feature_image_url VARCHAR(500) NULL,
    home_feature_order INT NOT NULL DEFAULT 0,
    home_feature_group ENUM('featured', 'recommended', 'none') NOT NULL DEFAULT 'none',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
